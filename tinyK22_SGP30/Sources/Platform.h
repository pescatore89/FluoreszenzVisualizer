...
#define PL_CONFIG_POWER_ENABLED	  			(1) /* number of connected Power Supplies */
#define PL_CONFIG_MAX_CURRENT_PER_SUPPLY	(10) /* max current per Power Supply*/
#define PL_CONFIG_MAX_CURRENT_SUPPLY		((PL_CONFIG_MAX_CURRENT_PER_SUPPLY)*(PL_CONFIG_MAX_CURRENT_PER_SUPPLY))	/* Total amount op ampers allowed*/
